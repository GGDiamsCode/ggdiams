...
bot.on('message', message => {
    ...
    if (message.content === prefix + "help"){
        message.channel.reply("Nous envoyons le message d'aide")
        console.log("Commande /help (0) effectué")
    }
    
    if (message.content === prefix + "help"){
        var embed = new Discord.RichEmbed()
            .setTitle("**HELP**")
            .setDescription("Commandes basqiues et commandes d'admin :")
            .addField("/help 🆘   /ip 🕹   /news 📰   /infodiscord \n /lastversion 📤   /update 📥   /site 🔗 \n /joke 🤣   /staff 👑   /msgprivehelp 🛠   /connectaccount 📡 \n /ats.setup.exe 📥   /youtube 🎥   /twitter 🐤   /demande.event 📢   /boutique<ggc,ggd> \n /codelines 💻   /commandsnumb 🔢   /invite 📩📨   /binfo (infos basiques)   /ainfo (infos avancées)")
            .addField("/kick 🚪 \n /ban 🚨")
            .setColor("0x27AE60")
        ...
        console.log("Commande /help (1) effectué.");
    }
    ...
    if (message.content === prefix + "ainfo"){
        var embed = new Discord.RichEmbed()
            .setTitle("VOS INFORMATIONS")
            .setDescription("Informations d'un joueur")
            .addField(`PEUDONYME 🗨 : **${message.author.username}**     DISCRI. 🌐 : **#${message.author.discriminator}**\n\nID 🆔 : **${message.author.id}**     LAST MSG 🗨: **${message.author.lastMessage}**`)
            .addField("Commande en développement, en cas de problèmes, contactez eXtra Geek Style#7070")
            .addField("By Alterra Tech Space")
            .setColor("0x27AE60")
            .setFooter("Powered by Alterra Tech Space©, (https://alterratechspace.wixsite.com/alterra-tech-space) | eXtra Geek Style#7070")
